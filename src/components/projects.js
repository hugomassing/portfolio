...
const projects = [
  {
    ...
    description: (
      <>
        Website created for Maazel{"\n"}
        Made with {link("Next.js", nextjs)},{" "}
        {link("Styled Components", styledComponents)} and {link("Figma", figma)}
        .{"\n"}
  ...
  },
  {
    ...
    description: (
      <>
        ...
        Made with {link("React.js", react)},{" "}
        {link("Styled Components", styledComponents)}.{"\n"}
        Hosted on {link("zeit.co", zeit)}
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        Webradio for qatataq{"\n"}
        Made with {link("React.js", react)}, {link("Redux", redux)},{" "}
        {link("Radioking", radioking)}.{"\n"}
        Hosted on {link("zeit.co", zeit)}
      </>
    ),
      ...
      {projects.map((project, index) => (
        ...
        >
          ...
          <ImgWrapper>
            <Img src={project.img} />
            <a href={project.link}>
              <Button visible={highlightedProject === index}>Visit</Button>
            </a>
          </ImgWrapper>
        </Project>
      ))}
