  ...
  return (
    <ContactsContainer>
      <ContactItem>
        ...
        >
          <HideSmall>github.com/</HideSmall>hugomassing
        </a>
      </ContactItem>
      <ContactItem>
        <Icon>
        ...
        <a
          href="https://twitter.com/SICARMY__"
          target="_blank"
          rel="noreferrer noopener"
        >
          <HideSmall>twitter.com/</HideSmall>SICARMY__
        </a>
      </ContactItem>
      <ContactItem>
        <Icon>
        ...
        <a
          href="https://linkedin.com/in/hugomassing"
          target="_blank"
          rel="noreferrer noopener"
        >
          <HideSmall>linkedin.com/in/</HideSmall>hugomassing/
        </a>
      </ContactItem>
      <ContactItem>
